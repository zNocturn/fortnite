...
async def event_friend_message(message):
    ...
    if "!skin" in args[0].lower():
        if message.author.display_name in data['BlockList']:
            ...
            try:
                ...
                await message.reply('Se a puesto la skin: ' + f'{cosmetic.name}')
            except BenBotAsync.exceptions.NotFound:
                await message.reply(f'No se encontro la skin llamada: {joinedArguments}')
        ...
        if message.author.display_name in data['BlockList']:
            ...
            if len(args) == 1:
                ...
                try:
                    ...
                    await message.reply(f'No se encontro la mochila llamada: {joinedArguments}')
    ...
    if "!pid" in args[0].lower():
        if message.author.display_name in data['BlockList']:
            ...
            try:
                ...
                await message.reply(f'No se encontro el pico llamado: {joinedArguments}')
    ...
    if "!emote" in args[0].lower():
        if message.author.display_name in data['BlockList']:
            ...
            try:
                ...
                await message.reply('Se a puesto el gesto:  ' + f'{cosmetic.name}')
            except BenBotAsync.exceptions.NotFound:
                await message.reply(f'No se encontro el emote llamado: {joinedArguments}')
    ...
    if "!filtrated2" in args[0].lower():
        await client.user.party.me.set_outfit(
            asset='CID_659_athena_commando_m_mriceguy',
            variants=client.user.party.me.create_variants(
                progressive=4
                ),
            enlightenment=(2, 350)
    ...
    if "help" in args[0].lower():
        if message.author.display_name in data['BlockList']:
            ...
            await message.reply('Bot creado por: KaosDrip | Modificado por: TRUX_YT')
